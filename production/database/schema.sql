...
-- EXTENSIONS
-- ============================================================
CREATE EXTENSION IF NOT EXISTS vector;          -- pgvector: VECTOR(3072) semantic search
...
-- Embeddings generated by Gemini text-embedding-004 (768d).
-- ============================================================
CREATE TABLE IF NOT EXISTS knowledge_base (
    ...
    -- Vector embedding (Gemini text-embedding-004 = 3072 dims)
...
COMMENT ON COLUMN knowledge_base.embedding IS 'Gemini text-embedding-004 output. 768 dimensions. Used for cosine similarity search via pgvector.';
